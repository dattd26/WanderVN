  ...
  useEffect(() => {
    const fetchHotels = async () => {
      try {
        setLoading(true);
        setError(null);
        // Gọi API lấy toàn bộ khách sạn (không lọc status ở DB để tính toán bộ đếm trên các tab cùng lúc)
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-4">
          <div className="flex flex-wrap gap-2 bg-surface-container/60 p-1.5 rounded-xl border border-outline-variant/40 backdrop-blur-md">
            ...
            <button
              ...
              className={`font-label-md text-caption uppercase tracking-wider px-5 py-2.5 rounded-lg transition-all duration-200 ${
                activeTab === 'all'
            ...
            <button
              ...
              className={`font-label-md text-caption uppercase tracking-wider px-5 py-2.5 rounded-lg transition-all duration-200 flex items-center gap-2.5 ${
                activeTab === 'pending'
